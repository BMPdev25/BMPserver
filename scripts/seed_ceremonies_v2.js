...
const ceremonies = [
  // --- DEITY PUJAS (Image: deity_puja.png) ---
  {
    ...
    requirements: {
      materials: [
        ...
        { name: "Turmeric Powder (Haldi)", quantity: "50g", isOptional: false, providedBy: "devotee" },
        { name: "Kumkum (Vermillion)", quantity: "1 packet", isOptional: false, providedBy: "devotee" },
        { name: "Incense Sticks (Agarbatti)", quantity: "1 packet", isOptional: false, providedBy: "devotee" },
        { name: "Camphor (Kapoor)", quantity: "Small box", isOptional: false, providedBy: "devotee" },
        ...
        { name: "Fruits (Banana, Apple)", quantity: "5 pieces", isOptional: false, providedBy: "devotee" },
  ...
  },
  {
    ...
    requirements: {
      materials: [
        ...
        { name: "Panchamrut (Milk, Curd, Ghee, Honey, Sugar)", quantity: "1 set", isOptional: false, providedBy: "devotee" },
  ...
  },
  {
    ...
    requirements: {
      materials: [
        ...
        { name: "Books/Instruments (for blessing)", quantity: "As needed", isOptional: true, providedBy: "devotee" },
        { name: "Incense Sticks", quantity: "1 packet", isOptional: false, providedBy: "devotee" },
        { name: "Camphor", quantity: "Small box", isOptional: false, providedBy: "devotee" },
      ...
      specialInstructions: ["Place books and musical instruments near the puja area for blessings."]
    }
  },
  ...
  // --- FIRE RITUALS (Image: havan.png) ---
  {
    ...
    history: "The Maha Mrityunjaya mantra is one of the oldest and most powerful Vedic mantras, found in the Rig Veda. This homa is performed to seek Lord Shiva's protection from illness and death. It is often conducted during health crises, birthdays, or to mark recovery from illness.",
    category: "puja",
    subcategory: "havan",
    ...
    requirements: {
      materials: [
        { name: "Ghee (Clarified Butter)", quantity: "1 kg", isOptional: false, providedBy: "devotee" },
        { name: "Havan Samagri (Pre-mixed)", quantity: "500g", isOptional: false, providedBy: "priest" },
        ...
        { name: "Black Sesame Seeds (Til)", quantity: "250g", isOptional: false, providedBy: "devotee" },
      ...
      specialInstructions: ["Ensure proper ventilation.", "Keep fire extinguisher or water bucket nearby."]
    }
  },
  {
    name: "Navagraha Shanti Homa",
    description: "Ceremony to appease the nine planetary deities and remove astrological doshas.",
    history: "Navagraha worship traces its roots to Vedic astrology (Jyotish Shastra). The nine planets — Surya, Chandra, Mangal, Budh, Guru, Shukra, Shani, Rahu, and Ketu — influence all aspects of human life. This homa pacifies unfavorable planetary positions in one's horoscope.",
    category: "puja",
    subcategory: "havan",
    ...
    requirements: {
      materials: [
        ...
        { name: "Flowers (mixed colors)", quantity: "1 bunch", isOptional: false, providedBy: "devotee" },
        { name: "Coconut", quantity: "1", isOptional: false, providedBy: "devotee" },
        { name: "Incense Sticks", quantity: "1 packet", isOptional: false, providedBy: "devotee" },
  ...
  },
  {
    ...
    history: "Vastu Shastra is the ancient Indian science of architecture and spatial arrangement. Vastu Shanti Puja is performed to harmonize the five elements (Panch Mahabhuta) in a new dwelling and appease Vastu Purusha, the deity of directions. It ensures peace, prosperity, and protection from negative influences.",
    ...
    requirements: {
      ...
      specialInstructions: ["Home should be cleaned before the puja.", "Boil milk to overflowing as part of Griha Pravesh ritual."]
    }
  },
  {
    ...
    history: "Upanayana is one of the 16 Samskaras (sacraments) in Hinduism, marking the child's entry into formal education under a Guru. The sacred thread (Yagnopavita) represents the three debts — to the sages, ancestors, and gods. This ceremony has been practiced since Vedic times and is considered a spiritual rebirth.",
    ...
    requirements: {
      materials: [
        { name: "Yagnopavita (Sacred Thread)", quantity: "1", isOptional: false, providedBy: "priest" },
        ...
        { name: "Ajina (Deer Skin or Cloth)", quantity: "1", isOptional: true, providedBy: "devotee" },
        { name: "Ghee", quantity: "500g", isOptional: false, providedBy: "devotee" },
        { name: "Havan Samagri", quantity: "500g", isOptional: false, providedBy: "priest" },
        { name: "New Dhoti for the child", quantity: "1", isOptional: false, providedBy: "devotee" },
        { name: "Coconut", quantity: "2", isOptional: false, providedBy: "devotee" },
        { name: "Flowers & Fruits", quantity: "1 set", isOptional: false, providedBy: "devotee" },
        { name: "Havan Kund", quantity: "1", isOptional: false, providedBy: "either" }
      ],
      specialInstructions: ["The child should fast from the previous night.", "New white/yellow clothes for the child."]
    }
  },
  ...
  // --- BABY CEREMONIES (Image: baby_ceremony.png) ---
  {
    ...
    history: "Namkaran is one of the 16 Samskaras in Hinduism. It is traditionally performed on the 11th or 12th day after birth. The name is chosen based on the child's Nakshatra (birth star) and horoscope. A formal announcement is made to family and community, and the priest chants mantras for the child's well-being.",
    ...
    requirements: {
      ...
      specialInstructions: ["Baby should be bathed and dressed in new clothes before the ceremony."]
    }
  },
  {
    name: "Annaprashan",
    description: "First rice-feeding ceremony, marking the baby's transition to solid food.",
    history: "Annaprashan, also known as the first rice-feeding ceremony, is performed when the baby is 6-7 months old. It marks the child's transition from mother's milk to solid food. The ceremony symbolizes the child's growth and is believed to bless the child with a healthy appetite and good health.",
    category: "baby-naming",
    subcategory: "samskara",
    duration: { typical: 60, minimum: 45, maximum: 90 },
    pricing: { basePrice: 2100, priceRange: { min: 2100, max: 3100 }, factors: [] },
    ...
    requirements: {
      ...
      specialInstructions: ["Baby should be dressed in new clothes.", "Place symbolic items (book, pen, clay, gold) for the baby to pick."]
    }
  },
  {
    name: "Mundan Sanskar",
    description: "Head tonsuring ceremony for the child, symbolizing purity and the shedding of past life's negativity.",
    history: "Mundan Sanskar is believed to cleanse the child by removing the birth hair, which is considered impure. The ceremony usually takes place in the first or third year of the child's life. It is believed to stimulate brain growth, strengthen the skull, and mark a fresh start in the child's life.",
    ...
    requirements: {
      materials: [
        ...
        { name: "Coconut", quantity: "1", isOptional: false, providedBy: "devotee" },
        { name: "New Clothes for Child", quantity: "1 set", isOptional: false, providedBy: "devotee" },
        { name: "Flowers & Fruits", quantity: "1 set", isOptional: false, providedBy: "devotee" },
        { name: "Incense & Camphor", quantity: "1 set", isOptional: false, providedBy: "devotee" }
      ],
      specialInstructions: ["Arrange a barber in advance.", "Apply turmeric paste on the child's head after shaving."]
    }
  },
  ...
  // --- WEDDING RITUALS (Image: wedding.png) ---
  {
    ...
    history: "Vivah is the most sacred of all Hindu Samskaras. It unites two souls and two families through sacred fire and Vedic mantras. The Saptapadi (seven steps) represents seven vows taken around the fire, and the ceremony typically includes Kanyadaan, Mangal Sutra, Sindoor, and blessings from elders.",
    category: "wedding",
    subcategory: "samskara",
    ...
    requirements: {
      materials: [
        ...
        { name: "Sacred Fire (Havan Kund)", quantity: "1", isOptional: false, providedBy: "either" },
        { name: "Puffed Rice (Lajja Hom)", quantity: "500g", isOptional: false, providedBy: "devotee" },
        { name: "Flowers & Fruits", quantity: "1 large set", isOptional: false, providedBy: "devotee" }
      ],
      spaceRequirements: "Mandap (canopy) area with seating for families.",
      specialInstructions: ["Mandap should be set up before the priest arrives.", "Both families should be present for Kanyadaan."]
    }
  },
  {
    name: "Sagaai (Engagement)",
    description: "Ring exchange ceremony marking the formal agreement of marriage between families.",
    history: "Sagaai, or the engagement ceremony, is the formal announcement of a couple's intention to marry. Both families exchange rings, gifts, and sweets as a symbol of agreement. The ceremony is often accompanied by prayers and blessings from the priest.",
    category: "wedding",
  ...
  },
  {
    ...
    history: "The Roka ceremony is a North Indian tradition that formally initiates the marriage process. It involves the girl's family visiting the boy's family to 'reserve' or 'block' the groom. Gifts, dry fruits, and shagun (auspicious amount) are exchanged, symbolizing the families' acceptance of each other.",
    category: "wedding",
    subcategory: "pre-wedding",
    duration: { typical: 60, minimum: 45, maximum: 90 },
    ...
    requirements: {
      materials: [
        ...
        { name: "Shagun Envelope (Cash Gift)", quantity: "1", isOptional: false, providedBy: "devotee" },
        { name: "Coconut", quantity: "1", isOptional: false, providedBy: "devotee" },
  ...
  // --- HOLY READINGS (Image: reading.png) ---
  {
    ...
    history: "Sundarkand is the fifth book of the Ramayana, describing Hanuman's journey to Lanka to find Sita. It is considered the most beautiful (Sundar) chapter. Regular recitation is believed to remove obstacles, grant courage, and bring peace. It is often performed on Tuesdays and Saturdays.",
    category: "puja",
    subcategory: "reading",
    duration: { typical: 150, minimum: 120, maximum: 180 },
  ...
  },
  {
    ...
    history: "Akhand Ramayan Path is a non-stop recitation of Goswami Tulsidas's Ramcharitmanas, spanning 24 hours. It requires a team of priests who take turns reading. This path is performed during auspicious occasions, festivals, or to seek divine intervention during difficult times. It fills the home with sacred vibrations.",
    category: "puja",
    subcategory: "reading",
    ...
    requirements: {
      materials: [
        ...
        { name: "Seating Arrangements for Priests", quantity: "For team", isOptional: false, providedBy: "devotee" }
      ],
      spaceRequirements: "Dedicated room or area that can remain undisturbed for 24+ hours.",
      specialInstructions: ["Reading must not be interrupted once started.", "At least one listener should be present at all times."]
    },
    ritualSteps: [
      { stepNumber: 1, title: "Sankalpam", description: "Vowing to complete the parayan with devotion.", durationEstimate: 10 },
      { stepNumber: 2, title: "Katha Path", description: "Continuous reading of the sacred text.", durationEstimate: 120 }
    ]
  },
  {
    name: "Satyanarayan Puja",
    description: "A popular ritual dedicated to Lord Vishnu in his form as Satyanarayan (The Lord of Truth).",
    history: "Satyanarayan Puja is one of the most common and beloved Hindu rituals. It is performed on any auspicious occasion or on Purnima (full moon) days. The ritual emphasizes the importance of truth and gratitude. It involves the reading of the Satyanaran Katha, which consists of five short stories illustrating the benefits of performing the puja and the consequences of neglecting it.",
    category: "puja",
    subcategory: "deity",
    duration: { typical: 120, minimum: 90, maximum: 150 },
    pricing: { basePrice: 2100, priceRange: { min: 2100, max: 3500 }, factors: [] },
    religiousTraditions: ["Hindu"],
    images: [{ url: "/public/images/ceremonies/deity_puja.png", alt: "Satyanarayan Puja Setup", isPrimary: true }],
    requirements: {
      materials: [
        { name: "Satyanarayan Photo", quantity: "1", isOptional: false, providedBy: "devotee" },
        { name: "Banana Stems & Leaves", quantity: "4 stems", isOptional: false, providedBy: "devotee" },
        ...
        { name: "Suji (Semolina) for Prasad", quantity: "250g", isOptional: false, providedBy: "devotee" },
        { name: "Sugar & Milk for Prasad", quantity: "As needed", isOptional: false, providedBy: "devotee" },
    ...
    ritualSteps: [
      { stepNumber: 1, title: "Ganesh & Navagraha Puja", description: "Initial worship to avoid obstacles and seek planetary blessings.", durationEstimate: 20 },
      { stepNumber: 2, title: "Satyanarayan Avahana", description: "Invoking Lord Satyanarayan into the main deity/kalash.", durationEstimate: 15 },
      { stepNumber: 3, title: "Satyanarayan Katha", description: "Reading and listening to the five sacred stories of the ritual.", durationEstimate: 60 },
      { stepNumber: 4, title: "Aarti & Distribution of Prasad", description: "Concluding prayers and sharing the blessed offering.", durationEstimate: 25 }
    ]
  },
  {
    name: "Griha Pravesh",
    description: "Housewarming ceremony performed when entering a new house for the first time.",
    history: "Griha Pravesh is a sacred ceremony to purify a new home and protect it from negative energies. It is usually performed on an auspicious date (Muhurta) determined by the lunar calendar. The ritual involves Vastu Shanti (to appease the gods of directions) and Navagraha Homa. Boiling milk until it overflows is a symbolic tradition representing abundance and prosperity.",
    category: "housewarming",
    subcategory: "domestic",
    duration: { typical: 180, minimum: 120, maximum: 240 },
    pricing: { basePrice: 5100, priceRange: { min: 5100, max: 11000 }, factors: [] },
    religiousTraditions: ["Hindu"],
    images: [{ url: "/public/images/ceremonies/housewarming.png", alt: "Griha Pravesh Setup", isPrimary: true }],
    requirements: {
      materials: [
        ...
        { name: "Toran (Mango leaves string)", quantity: "1", isOptional: false, providedBy: "devotee" },
    ...
    ritualSteps: [
      { stepNumber: 1, title: "Dwara Puja", description: "Worshipping the main entrance of the house.", durationEstimate: 15 },
      { stepNumber: 2, title: "Vastu Shanti & Navagraha Homa", description: "Sacred fire ritual to purify the space and appease planetary deities.", durationEstimate: 90 },
      { stepNumber: 3, title: "Milk Boiling Ritual", description: "Symbolic boiling of milk in the kitchen until it overflows.", durationEstimate: 20 },
      { stepNumber: 4, title: "Ganapati Aarti & Satyanarayan Path", description: "Final prayers and establishment of the deity in the new home.", durationEstimate: 55 }
    ]
  },
  {
    name: "Ganapati Homa",
    description: "Sacred fire ritual dedicated to Lord Ganesha for success and removal of obstacles.",
    history: "Ganapati Homa is a powerful Vedic fire ritual. It is often performed early in the morning, usually before sunrise. The offerings of Modak, Ghee, and Ashwagandha into the sacred fire are believed to invoke the energy of Ganesha directly. It is recommended for students, businessmen, and anyone facing persistent hurdles in their life path.",
    category: "puja",
    subcategory: "homa",
    duration: { typical: 90, minimum: 60, maximum: 120 },
    pricing: { basePrice: 3500, priceRange: { min: 3500, max: 7500 }, factors: [] },
    religiousTraditions: ["Hindu"],
    images: [{ url: "/public/images/ceremonies/homa.png", alt: "Ganapati Homa Setup", isPrimary: true }],
    requirements: {
      materials: [
    ...
    ritualSteps: [
      { stepNumber: 1, title: "Agni Mukham", description: "Preparing the sacred fire and invoking the god of fire, Agni.", durationEstimate: 20 },
      { stepNumber: 2, title: "Ganapati Atharvashirsha Ahuti", description: "Offering oblations while chanting the sacred Ganesha hymns.", durationEstimate: 40 },
      { stepNumber: 3, title: "Purnahuti", description: "The final offering representing the complete surrender and fulfillment of the ritual.", durationEstimate: 10 },
      { stepNumber: 4, title: "Ganesha Aarti", description: "Closing prayers and distribution of the sacred ash (Vibhuti).", durationEstimate: 20 }
    ]
  }
];
