...
const categories = [
  ...
  { name: 'Birth & Naming', slug: 'baby-naming', icon: 'happy-outline', color: '#45B7D1', order: 4 },
  { name: 'Festivals', slug: 'festival', icon: 'sparkles-outline', color: '#F9D423', order: 5 },
  { name: 'Special Occasions', slug: 'special-occasion', icon: 'star-outline', color: '#6C5CE7', order: 6 },
  { name: 'Daily Worship', slug: 'daily-worship', icon: 'sunny-outline', color: '#A8E6CF', order: 7 },
  { name: 'Thread Ceremony', slug: 'thread-ceremony', icon: 'ribbon-outline', color: '#FFD93D', order: 8 },
...
const demoCeremonies = [
  {
    ...
    basePrice: 2100,
    images: [{ url: 'https://images.unsplash.com/photo-1609234656388-0b5a1e3e8908?w=300', alt: 'Puja', isPrimary: true }],
    isActive: true
  },
  {
    name: 'Griha Pravesh',
    ...
    images: [{ url: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=300', alt: 'House', isPrimary: true }],
    isActive: true
  },
  {
    name: 'Ganapati Homa',
    ...
    images: [{ url: 'https://images.unsplash.com/photo-1567591370504-83a1d0a6a5fa?w=300', alt: 'Homa', isPrimary: true }],
    isActive: true
  },
  {
    ...
    images: [{ url: 'https://images.unsplash.com/photo-1519741497674-611481863552?w=300', alt: 'Wedding', isPrimary: true }],
    isActive: true
  }
];
